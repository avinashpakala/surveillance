...
function CameraVideo() {
  ...
  const videoUrl = "https://youtu.be/X3zdKKcargo"; // Replace with your own video URL
            ...
            <div class="page-wrapper">
              <Container style={{ marginLeft: "20px" }}>
                ...
                <Row>
                  ...
                  <iframe width="1033" height="581" src="https://www.youtube.com/embed/X3zdKKcargo" title="Covenant School Shooting: Surveillance video shows shooter enter Nashville school" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                  </Col>
                  {/* <Col sm={4}>
